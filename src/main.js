...
async function driverPage() {
  ...
  document.querySelector("#driver-form").onsubmit = async (event) => {
    ...
    try {
      ...
      if (!file) throw new Error("La foto e obbligatoria. Scatta una foto del materiale prima di registrare il movimento.");
      Object.assign(data, await uploadPaintingPhoto(file, data.job_code || data.client_name));
